...
public final class indexx_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<h2><strong>Giới thiệu cách lọc danh sách theo một tiêu chí nào đó.</strong></h2>\n");
      out.write("\t\t\t<p>Cụ thể trong bài này ,chúng ta sẽ lọc danh sách thành viên theo họ ;</p>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"\">\n");
      out.write("\t\t\t<center><strong>Chọn họ mà bạn muốn tìm : </strong>");
...
for(int i=0;i<ds.size();i++){ 
      ...
      out.write("</td>\n");
      out.write("\t\t                          <td>");
      out.print(ds.get(i).getMaNhanVien());
      out.write("</td>\n");
      out.write("\t\t                          <td>");
      out.print(ds.get(i).getTenNhanVien());
      out.write("</td>\n");
      out.write("\t\t                          <td>");
      out.print(ds.get(i).getMucLuong() );
      out.write("</td>\n");
      out.write("                                          <td>");
      out.print(ds.get(i).getKinhNghiem());
      out.write("</td>\n");
      out.write("                                          <td>");
      out.print(ds.get(i).getDanhGia() );
      out.write("</td>\n");
      out.write("\t\t                        </tr>\n");
      out.write("\t\t                 ");
} 
