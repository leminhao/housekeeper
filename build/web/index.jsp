	...
	<!-- Menu-->
	 ...
	 <!--Form đăng nhập-->
		<div id="id01" class="modal">
			<br><br><br>
		  <form action="KhachHangServlet" name="Login" class="modal-content animate" method="POST">
			...
			<!-- Nơi display thông báo lỗi -->
			  ...
			  <input id="username_login" type="text" placeholder="Nhập tên đăng nhập" name="taiKhoan" required><br>

			  <p><b>Mật khẩu:</b></p>
			  <input id="password_login" type="password" placeholder="Nhập mật khẩu" name="matKhau" required>
